...
export default async function SupportPage() {
  ...
  return <PublicDoc
    ...
    sections={[
      { title: t("Contact"), body: <p>{t("Email {email}. Include the CodeLocal version, protocol version, runtime status and a correlation/request ID when available. Do not send passwords, OAuth tokens, approval tokens, .env files or private source code.", { email: supportEmail })}</p> },
      { title: t("First checks"), body: <ul><li><code>codelocal --version</code>: {t("Check the version and confirm the expected release channel.")}</li><li><code>codelocal</code>: {t("Start the runtime and confirm the paired runtime is online.")}</li><li><code>codelocal .</code>: {t("Run only inside a project you intend to authorize.")}</li><li>{t("If an AI client shows an old tool surface, reconnect or refresh CodeLocal in that client after updating the runtime.")}</li></ul> },
