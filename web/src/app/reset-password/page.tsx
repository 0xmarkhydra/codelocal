...
export default async function ResetPasswordPage({ searchParams }: Props) {
  ...
  return (
    <AuthShell
      ...
      panelTitle={done ? "Password reset" : "Choose a new password"}
      panelSubtitle={done ? "Your account is ready for a fresh sign-in." : "The reset code expires after 10 minutes."}
    >
