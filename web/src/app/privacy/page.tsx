...
export default async function PrivacyPage() {
  ...
  return <PublicDoc
    ...
    summary={t("CodeLocal is designed to keep raw development data and execution on the user's machine while storing only the cloud data needed for identity, routing and durable Project Brain features.")}
    sections={[
