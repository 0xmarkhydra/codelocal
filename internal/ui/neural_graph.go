...
/* Refined graph stage: quieter chrome, brighter evidence, less dashboard-inside-dashboard. */
.neural-card{border-color:#1a2a42;border-radius:16px;background:#050910;box-shadow:0 22px 64px rgba(0,0,0,.24)}.neural-toolbar{min-height:60px;padding:11px 14px;border-bottom-color:#142238;background:linear-gradient(180deg,#09111d,#070e17)}.neural-search,.neural-select{height:39px;border-color:#1d2e48;background:#07101b;color:#dbe6f4}.neural-search::placeholder{color:#5f718a}.neural-toolbar .btn{height:39px;border-color:#233651;background:#0b1625;color:#aebed2}.neural-legend{color:#657893}.neural-shell{grid-template-columns:minmax(0,1fr) 300px;height:min(720px,calc(100dvh - 188px));min-height:540px}.neural-canvas-wrap{background:radial-gradient(circle at 50% 44%,rgba(40,86,175,.16),transparent 40%),radial-gradient(circle at 16% 82%,rgba(102,68,190,.09),transparent 32%),#050910}.neural-grid{opacity:.30;background-size:42px 42px}.neural-detail{border-left-color:#142238;background:linear-gradient(180deg,#080f19,#060b12)}.neural-detail-inner{padding:17px}.neural-node-card{border-color:#1b2b43;border-radius:13px;background:#09131f}.neural-properties,.neural-relation{border-color:#17263c}.neural-relation{background:#08111d}.neural-help{border-color:#1b2d47;background:rgba(5,10,18,.86);color:#697c96}.neural-empty{background:rgba(5,9,16,.86)}
@media(max-width:900px){.neural-shell{grid-template-columns:1fr;height:auto}.neural-canvas-wrap,.neural-canvas{height:560px;min-height:560px}}
@media(max-width:560px){.neural-card{border-radius:14px}.neural-toolbar{padding:10px}.neural-canvas-wrap,.neural-canvas{height:490px;min-height:490px}}
