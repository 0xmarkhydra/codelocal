...
@media(max-width:900px){.security-grid{grid-template-columns:1fr}}@media(max-width:760px){.kv{grid-template-columns:1fr;gap:3px}}@media(max-width:600px){.setup-step{grid-template-columns:1fr;padding:21px}.step-number{width:40px;height:40px;border-radius:12px}.plugin-spec{grid-template-columns:1fr;gap:4px}}
`
