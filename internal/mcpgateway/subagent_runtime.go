...
//
// Activation gate: public surface v7 does not expose agent.team. Keep this seam
// dormant until child engine execution, path-scope enforcement, serialized
// mutation, and restart recovery have end-to-end coverage.
