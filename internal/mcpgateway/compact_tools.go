...
func compactToolDefinitions() []compactToolDef {
	...
	tools := []compactToolDef{
		...
		{
			Name: "terminal", Title: "Use terminal", Description: "Preflight a command, inspect terminal history, or run/start guarded host processes. Local policy and ChatGPT approval remain authoritative.",
