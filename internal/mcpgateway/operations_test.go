...
var frozenRuntimeToolNames = []string{
	"list_devices", "list_device_identities", "revoke_device", "rename_device", "list_workspaces", "select_workspace", "workspace_info", "memory_remember", "memory_recall", "learned_skill_list",
