...
// a handful of anecdotal runs cannot dominate routing. Only rows whose
// subagent outcome passed the join gate (done + verified) participate; blocked
// or failed members never boost ranking.
//
