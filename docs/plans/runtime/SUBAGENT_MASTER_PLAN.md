...
Status: Foundation implemented; public `agent.team` activation deferred until engine-backed child execution and recovery gates pass
Date: 2026-09-05
Owner: CodeLocal
Related:
...
>
> Trạng thái 2026-09-11: registry, validation, routing, affinity schema và bounded runtime seam đã có test. Public MCP vẫn giữ surface v7 và chưa quảng cáo `agent.team`; runtime seam chưa được gọi cho tới khi mỗi child chạy engine/context riêng, scope được enforce, mutation được serialize và recovery chaos gate pass.
