...
These instructions apply to `src/**` and override the repository root instructions for this subtree.
...
- Do not move or delete this tree until the physical deletion gate in `LEGACY_RUNTIME.md` is satisfied with external evidence.
